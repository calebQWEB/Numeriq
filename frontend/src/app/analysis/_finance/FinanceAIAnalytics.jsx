...
const FinanceAIAnalytics = ({ analysis, spreadsheet_type }) => {
      ...
      >
        {showAnalysis ? (
          ...
          <div className="flex flex-col items-center justify-center p-8 text-center text-gray-400">
            ...
            <p className="text-lg">
              Ready to get insights from your financial data?
            </p>
...
export default FinanceAIAnalytics;
